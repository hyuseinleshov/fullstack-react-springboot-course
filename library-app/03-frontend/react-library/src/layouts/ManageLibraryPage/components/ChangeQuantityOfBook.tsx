...
export const ChangeQuantityOfBook: React.FC<{
  ...
  async function increaseQuantity() {
    ...
    }/admin/secure/increase/book/quantity?bookId=${props.book.id}`;
  ...
  async function decreaseQuantity() {
    const url = `${
      import.meta.env.VITE_API
    }/admin/secure/decrease/book/quantity?bookId=${props.book.id}`;
    const requestOptions = {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
  ...
  async function deleteBook() {
    const url = `${import.meta.env.VITE_API}/admin/secure/delete/book?bookId=${
      props.book.id
    }`;
    const requestOptions = {
      method: "DELETE",
        ...
        <div className="col-md-2">
          <div className="d-none d-lg-block">
            {props.book.img ? (
              ...
              <img src={defaultBookImage} width="123" height="196" alt="Book" />
            )}
          </div>
